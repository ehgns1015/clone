            ...
            <div className="col-xs-12 col-sm-3 col-md-3 col-lg-3">
              ...
              <div className="card price-range-card">
                ...
                <div className="card-body">
                  <BootstrapSlider min={10} max={1000} step={5} value={priceFilter} onSlide={handleOnSlide} />
                  <br />
                  <span className="amount-wrapper">
                    <span className="price-label">Price:</span>
                    <input type="text" id="price-min" readOnly value={`$ ${priceFilter[0]}`} />
                    <strong>-</strong>
                    <input type="text" id="price-max" readOnly value={`$ ${priceFilter[1]}`} />
                  </span>
                </div>
              </div>
            </div>
